...
var FullCalendar = (function (exports) {
        ...
        n.some(function (n) {
          ...
          n.__d &&
            ...
            (r = l.__P) &&
              ((u = []),
              ((i = c$1({}, t)).__v = t.__v + 1),
              I$1(r, t, i, l.__n, void 0 !== r.ownerSVGElement, null != t.__h ? [o] : null, u, null == o ? d(t) : o, t.__h),
              T$1(u, t),
              t.__e != o && _(t)));
        });
  }
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        ...
        I$1(n, k, (_ = _ || r$1), t, o, e, c, s, a),
          (b = k.__e),
          (p = k.ref) && _.ref != p && (w || (w = []), _.ref && w.push(_.ref, null, k), w.push(p, k.__c || b, k)),
          null != b
            ? (null == m && (m = b),
              'function' == typeof k.type && null != k.__k && k.__k === _.__k ? (k.__d = s = g$1(k, s, n)) : (s = x$1(n, k, _, A, b, s)),
              a || 'option' !== u.type ? 'function' == typeof u.type && (u.__d = s) : (n.value = ''))
            : s && _.__e == s && s.parentNode != n && (s = d(_));
      }
    for (u.__e = m, h = P; h--; )
      null != A[h] && ('function' == typeof u.type && null != A[h].__e && A[h].__e == u.__d && (u.__d = d(i, h + 1)), L$1(A[h], A[h]));
      ...
      n: if ('function' == typeof P) {
        if (
          ...
          i.__c
            ...
            : ('prototype' in P && P.prototype.render ? (u.__c = v = new P(g, x)) : ((u.__c = v = new p(g, x)), (v.constructor = P), (v.render = M$1)),
              w && w.sub(v),
              (v.props = g),
              v.state || (v.state = {}),
              (v.context = x),
          ...
          null != P.getDerivedStateFromProps && (v.__s == v.state && (v.__s = c$1({}, v.__s)), c$1(v.__s, P.getDerivedStateFromProps(g, v.__s))),
          (d = v.props),
          (_ = v.state),
          h)
        )
          ...
          if (
            (null == P.getDerivedStateFromProps && g !== d && null != v.componentWillReceiveProps && v.componentWillReceiveProps(g, x),
  ...
  function j$2(n, l, u, i, t, o, e, c) {
    ...
    if (null === _) p === d || (c && n.data === d) || (n.data = d);
      ...
      c ||
        ('value' in d && void 0 !== (k = d.value) && (k !== n.value || ('progress' === _ && !k)) && C$1(n, 'value', k, p.value, !1),
  ...
  n.vnode = function (n) {
    ...
    t &&
      e.class != e.className &&
      ((G.enumerable = 'className' in e), null != e.className && (r.class = e.className), Object.defineProperty(r, 'className', G)),
      (n.$$typeof = W),
      J && J(n);
  };
  var K = n.__r;
  ...
  function rangesEqual(range0, range1) {
    return (
      (range0.start === null ? null : range0.start.valueOf()) === (range1.start === null ? null : range1.start.valueOf()) &&
      (range0.end === null ? null : range0.end.valueOf()) === (range1.end === null ? null : range1.end.valueOf())
    );
  }
  function rangesIntersect(range0, range1) {
    return (
      (range0.end === null || range1.start === null || range0.end > range1.start) && (range0.start === null || range1.end === null || range0.start < range1.end)
    );
  }
  ...
  var DateEnv = /** @class */ (function () {
    ...
    DateEnv.prototype.diffWholeMonths = function (m0, m1) {
      ...
      if (timeAsMs(m0) === timeAsMs(m1) && calendarSystem.getMarkerDay(m0) === calendarSystem.getMarkerDay(m1)) {
        return (
          calendarSystem.getMarkerMonth(m1) - calendarSystem.getMarkerMonth(m0) + (calendarSystem.getMarkerYear(m1) - calendarSystem.getMarkerYear(m0)) * 12
        );
      }
      return null;
    };
  ...
  var RenderHook = /** @class */ (function (_super) {
    ...
    RenderHook.prototype.render = function () {
      ...
      return createElement(
        MountHook,
        {hookProps: hookProps, didMount: props.didMount, willUnmount: props.willUnmount, elRef: this.handleRootEl},
        function (rootElRef) {
          return createElement(
            ContentHook,
            {hookProps: hookProps, content: props.content, defaultContent: props.defaultContent, backupElRef: _this.rootElRef},
  ...
  var ViewRoot = /** @class */ (function (_super) {
    ...
    ViewRoot.prototype.render = function () {
      ...
      return createElement(
        MountHook,
        {hookProps: hookProps, didMount: options.viewDidMount, willUnmount: options.viewWillUnmount, elRef: props.elRef},
        function (rootElRef) {
  ...
  function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
    ...
    if (
      ...
      return __assign(
        __assign({}, sourceHash),
        ((_a = {}), (_a[sourceId] = __assign(__assign({}, eventSource), {isFetching: false, fetchRange: fetchRange})), _a),
      );
    }
    return sourceHash;
  }
  ...
  function parseToolbars(calendarOptions, calendarOptionOverrides, theme, viewSpecs, calendarApi) {
    ...
    var headerToolbar = calendarOptions.headerToolbar
      ? parseToolbar(calendarOptions.headerToolbar, calendarOptions, calendarOptionOverrides, theme, viewSpecs, calendarApi, viewsWithButtons)
      : null;
    var footerToolbar = calendarOptions.footerToolbar
      ? parseToolbar(calendarOptions.footerToolbar, calendarOptions, calendarOptionOverrides, theme, viewSpecs, calendarApi, viewsWithButtons)
      : null;
  ...
  var CalendarDataManager = /** @class */ (function () {
    ...
    CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
      ...
      var refiners = (this.currentCalendarOptionsRefiners = __assign(
        __assign(__assign(__assign(__assign({}, BASE_OPTION_REFINERS), CALENDAR_LISTENER_REFINERS), CALENDAR_OPTION_REFINERS), pluginHooks.listenerRefiners),
    ...
    CalendarDataManager.prototype.processRawViewOptions = function (viewSpec, pluginHooks, localeDefaults, optionOverrides, dynamicOptionOverrides) {
      ...
      var refiners = __assign(
        __assign(
          __assign(__assign(__assign(__assign({}, BASE_OPTION_REFINERS), CALENDAR_LISTENER_REFINERS), CALENDAR_OPTION_REFINERS), VIEW_OPTION_REFINERS),
  ...
  var SegHierarchy = /** @class */ (function () {
    ...
    SegHierarchy.prototype.isInsertionValid = function (insertion, entry) {
      return (
        (this.maxCoord === -1 || insertion.levelCoord + entry.thickness <= this.maxCoord) && (this.maxStackCnt === -1 || insertion.stackCnt < this.maxStackCnt)
      );
    };
    ...
    SegHierarchy.prototype.splitEntry = function (entry, barrier, hiddenEntries) {
      ...
      if (partCnt) {
        hiddenEntries.push.apply(
          hiddenEntries,
          __spreadArray(
            [__assign(__assign({}, entry), {spanStart: Math.max(barrier.spanStart, entry.spanStart), spanEnd: Math.min(barrier.spanEnd, entry.spanEnd)})],
            splitHiddenEntries,
          ),
        );
        return partCnt;
    ...
    SegHierarchy.prototype.findInsertion = function (newEntry) {
      ...
      for (level = 0; level < levelCnt; level += 1) {
        ...
        while (
          ...
          if (
            strictOrder || // vertically intersects?
            (resCoord < levelCoord + entry.thickness && resCoord + newEntry.thickness > levelCoord)
          ) {
      ...
      for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
        ...
        if (buttonName === 'title') {
          ...
          children.push(
            createElement(
              'button',
              __assign({disabled: isDisabled, className: buttonClasses.join(' '), onClick: buttonClick, type: 'button'}, ariaAttrs),
  ...
  var ViewContainer = /** @class */ (function (_super) {
    ...
    ViewContainer.prototype.render = function () {
      ...
      return createElement(
        'div',
        {ref: this.handleEl, onClick: props.onClick, className: classNames.join(' '), style: {height: height, paddingBottom: paddingBottom}},
        props.children,
      );
    };
  ...
  var CalendarContent = /** @class */ (function (_super) {
    ...
    CalendarContent.prototype.render = function () {
      ...
      return createElement(
        ...
        createElement(
          ViewContainer,
          {liquid: viewVGrow, height: viewHeight, aspectRatio: viewAspectRatio, onClick: this.handleNavLinkClick},
          ...
          return createElement(
            ...
            createElement(
              ...
              !dayMeta.isDisabled &&
                createElement(
                  'a',
                  __assign({ref: innerElRef, className: ['fc-col-header-cell-cushion', props.isSticky ? 'fc-sticky' : ''].join(' ')}, navLinkAttrs),
                  innerContent,
                ),
            ),
          );
        ...
        function (rootElRef, customClassNames, innerElRef, innerContent) {
          return createElement(
            ...
            createElement(
              'div',
              {className: 'fc-scrollgrid-sync-inner'},
              createElement('a', {className: ['fc-col-header-cell-cushion', props.isSticky ? 'fc-sticky' : ''].join(' '), ref: innerElRef}, innerContent),
            ),
          );
        },
      );
  ...
  var Slicer = /** @class */ (function () {
    ...
    Slicer.prototype.sliceNowDate = function (
      ...
      return this._sliceDateSpan.apply(this, __spreadArray([{range: {start: date, end: addMs(date, 1)}, allDay: false}, {}, context], extraArgs));
    };
    Slicer.prototype._sliceBusinessHours = function (businessHours, dateProfile, nextDayThreshold, context) {
      ...
      return this._sliceEventStore.apply(
        this,
        __spreadArray(
          [expandRecurring(businessHours, computeActiveRange(dateProfile, Boolean(nextDayThreshold)), context), {}, dateProfile, nextDayThreshold],
          extraArgs,
        ),
      ).bg;
    };
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    SimpleScrollGrid.prototype.render = function () {
      ...
      return createElement(
        ...
        Boolean(!isBuggy && headSectionNodes.length) && createElement.apply(void 0, __spreadArray(['thead', {}], headSectionNodes)),
        Boolean(!isBuggy && bodySectionNodes.length) && createElement.apply(void 0, __spreadArray(['tbody', {}], bodySectionNodes)),
        Boolean(!isBuggy && footSectionNodes.length) && createElement.apply(void 0, __spreadArray(['tfoot', {}], footSectionNodes)),
        isBuggy &&
          createElement.apply(void 0, __spreadArray(__spreadArray(__spreadArray(['tbody', {}], headSectionNodes), bodySectionNodes), footSectionNodes)),
      );
    };
  ...
  var DayCellRoot = /** @class */ (function (_super) {
    ...
    DayCellRoot.prototype.render = function () {
      ...
      return createElement(
        MountHook,
        {hookProps: hookProps, didMount: options.dayCellDidMount, willUnmount: options.dayCellWillUnmount, elRef: props.elRef},
        function (rootElRef) {
      ...
      _this.handleRenderRequest = function () {
        if (_this.isRendering) {
          ...
          render(
            createElement(
              CalendarRoot,
              {options: currentData_1.calendarOptions, theme: currentData_1.theme, emitter: currentData_1.emitter},
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              receivingContext_1.emitter.trigger(
                'drop',
                __assign(__assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext_1)), {
    ...
    function EventResizing(settings) {
      ...
      _this.handlePointerDown = function (ev) {
        ...
        _this.dragging.setIgnoreMove(
          !_this.component.isValidSegDownEl(ev.origEvent.target) || (ev.isTouch && _this.component.props.eventSelection !== eventRange.instance.instanceId),
        );
      };
      _this.handleDragStart = function (ev) {
        var context = _this.component.context;
      ...
      return createElement(
        ...
        function (rootElRef, classNames, innerElRef, innerContent) {
          return (
            ...
            createElement(
              'a',
              __assign({className: ['fc-daygrid-event', 'fc-daygrid-dot-event'].concat(classNames).join(' '), ref: rootElRef}, getSegAnchorAttrs(props.seg)),
              innerContent,
            )
          );
        },
    ...
    TableCellMoreLink.prototype.render = function () {
      ...
      return createElement(
                ...
                return createElement(
                  ...
                  hasListItemDisplay(seg)
                    ? createElement(
                        TableListItemEvent,
                        __assign(
                          {seg: seg, isDragging: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false},
        ...
        function (rootElRef, classNames, innerElRef, innerContent, handleClick) {
          return createElement('a', {ref: rootElRef, className: ['fc-daygrid-more-link'].concat(classNames).join(' '), onClick: handleClick}, innerContent);
        },
      );
    };
      ...
      return createElement(
        ...
        function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) {
          return createElement(
            'td',
            __assign(
              {ref: dayElRef, className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ')},
              rootDataAttrs,
              props.extraDataAttrs,
            ),
            createElement(
              'div',
              {className: 'fc-daygrid-day-frame fc-scrollgrid-sync-inner', ref: props.innerElRef /* different from hook system! RENAME */},
              props.showWeekNumber &&
                createElement(
                  ...
                  function (weekElRef, weekClassNames, innerElRef, innerContent) {
                    return createElement(
                      'a',
                      __assign({ref: weekElRef, className: ['fc-daygrid-week-number'].concat(weekClassNames).join(' ')}, navLinkAttrs),
                      innerContent,
                    );
                  },
                ),
  ...
  var TableRow = /** @class */ (function (_super) {
    ...
    TableRow.prototype.render = function () {
      ...
      var isForcedInvisible = (props.eventDrag && props.eventDrag.affectedInstances) || (props.eventResize && props.eventResize.affectedInstances) || {}; // TODO: messy way to compute this
      return createElement(
        'tr',
        {ref: this.rootElRef},
        ...
        props.cells.map(function (cell, col) {
          ...
          return createElement(TableCell, {
            ...
            fgContent: createElement(Fragment, null, createElement(Fragment, null, normalFgNodes), createElement(Fragment, null, mirrorFgNodes)),
            // Fragment scopes the keys
            ...
            createElement(
              ...
              hasListItemDisplay(seg)
                ? createElement(
                    TableListItemEvent,
                    __assign(
                      {seg: seg, isDragging: isDragging, isSelected: instanceId === eventSelection, defaultDisplayEventEnd: defaultDisplayEventEnd},
      ...
      if (framePositions) {
        for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
          ...
          nodes.push(
            createElement(
              'div',
              {key: buildEventRangeKey(seg.eventRange), className: 'fc-daygrid-bg-harness', style: leftRightCss},
              fillType === 'bg-event' ? createElement(BgEvent, __assign({seg: seg}, getSegMeta(seg, todayRange))) : renderFill(fillType),
            ),
          );
        }
      }
  ...
  var DayTable = /** @class */ (function (_super) {
    ...
    DayTable.prototype.render = function () {
      ...
      return createElement(
        Table,
        __assign({ref: this.tableRef}, this.slicer.sliceProps(props, props.dateProfile, props.nextDayThreshold, context, props.dayTableModel), {
          dateProfile: props.dateProfile,
    ...
    TableDateProfileGenerator.prototype.buildRenderRange = function (currentRange, currentRangeUnit, isRangeAllDay) {
      ...
      if (this.props.monthMode && this.props.fixedWeekCount) {
        var rowCnt = Math.ceil(
          // could be partials weeks due to hiddenDays
          diffWeeks(start, end),
        );
        ...
        if (options.weekNumbers && rowKey === 'day') {
          return createElement(
            ...
            function (rootElRef, classNames, innerElRef, innerContent) {
              return createElement(
                'th',
                {ref: rootElRef, className: ['fc-timegrid-axis', 'fc-scrollgrid-shrink'].concat(classNames).join(' ')},
                createElement(
                  'div',
                  {className: 'fc-timegrid-axis-frame fc-scrollgrid-shrink-frame fc-timegrid-axis-frame-liquid', style: {height: frameHeight}},
                  createElement(
                    'a',
                    __assign({ref: innerElRef, className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner'}, navLinkAttrs),
                    innerContent,
                  ),
                ),
              );
            ...
            function (rootElRef, classNames, innerElRef, innerContent) {
              return createElement(
                ...
                createElement(
                  ...
                  createElement(
                    'span',
                    {className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner', ref: innerElRef},
                    innerContent,
                  ),
                ),
              );
                    ...
                    createElement(NowTimer, {unit: isNowIndicator ? 'minute' : 'day' /* hacky */}, function (nowDate) {
                      ...
                      if (typeof nowIndicatorTop === 'number') {
                        return createElement(NowIndicatorRoot, {isAxis: true, date: nowDate}, function (rootElRef, classNames, innerElRef, innerContent) {
                          return createElement(
                            'div',
                            {ref: rootElRef, className: ['fc-timegrid-now-indicator-arrow'].concat(classNames).join(' '), style: {top: nowIndicatorTop}},
                            innerContent,
                          );
                        });
                      }
      ...
      return createElement(ViewRoot, {viewSpec: context.viewSpec, elRef: this.rootElRef}, function (rootElRef, classNames) {
        return createElement(
          ...
          createElement(ScrollGrid, {
            ...
            colGroups: [{width: 'shrink', cols: [{width: 'shrink'}]}, {cols: [{span: colCnt, minWidth: dayMinWidth}]}],
            sections: sections,
          }),
        );
      });
          ...
          return createElement(
            ...
            createElement(
              ...
              function (rootElRef, customClassNames, innerElRef, innerContent) {
                return createElement(
                  'td',
                  {ref: rootElRef, className: classNames.concat(customClassNames).join(' '), 'data-time': slatMeta.isoTimeStr},
                  innerContent,
                );
              },
            ),
        ...
        if (rootEl.offsetHeight) {
          ...
          props.onCoords(
            new TimeColsSlatsCoords(
              new PositionCache(this.rootElRef.current, collectSlatEls(this.slatElRefs.currentMap, props.slatMetas), false, true),
  ...
  function webToRects(topLevelNodes) {
    ...
    var processNode = cacheable(
      ...
      function (node, levelCoord, stackDepth) {
        var rect = __assign(__assign({}, node), {levelCoord: levelCoord, stackDepth: stackDepth, stackForward: 0});
        rects.push(rect);
  ...
  var TimeColMisc = /** @class */ (function (_super) {
    ...
    TimeColMisc.prototype.render = function () {
      ...
      return createElement(
        DayCellContent,
        {date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps},
        function (innerElRef, innerContent) {
  ...
  var TimeCol = /** @class */ (function (_super) {
    ...
    TimeCol.prototype.render = function () {
      ...
      return createElement(
        DayCellRoot,
        {elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps},
        function (rootElRef, classNames, dataAttrs) {
          return createElement(
            'td',
            __assign(
              {ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ')},
              dataAttrs,
              props.extraDataAttrs,
            ),
            createElement(
    ...
    TimeCol.prototype.renderPositionedFgSegs = function (
      ...
      var _c = isMirror
          ? computeFgSegPlacements(segInputs) // don't use memoized
      ...
      return createElement(
        ...
        segRects.map(function (segRect) {
          ...
          var instanceId = seg.eventRange.instance.instanceId;
          var positionCss = __assign(
            __assign({}, _this.computeSegTopBottomCss(segRect.segInput)),
            isMirror ? {left: 0, right: 0} : _this.computeSegLeftRightCss(segRect),
          );
          return createElement(
            'div',
            {
    ...
    TimeCol.prototype.renderFillSegs = function (segs, fillType) {
      ...
      var children = segInputs.map(function (segInput) {
        ...
        return createElement(
          'div',
          {key: buildEventRangeKey(seg.eventRange), className: 'fc-timegrid-bg-harness', style: _this.computeSegTopBottomCss(segInput)},
          fillType === 'bg-event' ? createElement(BgEvent, __assign({seg: seg}, getSegMeta(seg, props.todayRange, props.nowDate))) : renderFill(fillType),
        );
      });
      ...
      sortedFgSegs.map(function (seg) {
        ...
        return createElement(
          ...
          createElement(
            TimeColEvent,
            __assign(
              {seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === eventSelection, isShort: false},
              getSegMeta(seg, todayRange, nowDate),
            ),
          ),
        );
                  ...
                  createElement(
                    ...
                    createElement(
                      ...
                      typeof nowIndicatorTop === 'number' &&
                        createElement(NowIndicatorRoot, {isAxis: true, date: props.nowDate}, function (rootElRef, classNames, innerElRef, innerContent) {
                          return createElement(
                            'div',
                            {ref: rootElRef, className: ['fc-timegrid-now-indicator-arrow'].concat(classNames).join(' '), style: {top: nowIndicatorTop}},
                            innerContent,
  ...
  var DayTimeCols = /** @class */ (function (_super) {
    ...
    DayTimeCols.prototype.render = function () {
      ...
      return createElement(NowTimer, {unit: isNowIndicator ? 'minute' : 'day'}, function (nowDate, todayRange) {
        return createElement(
          TimeCols,
          __assign({ref: _this.timeColsRef}, _this.slicer.sliceProps(props, dateProfile, null, context, dayRanges), {
            forPrint: props.forPrint,
            axis: props.axis,
            dateProfile: dateProfile,
            slatMetas: props.slatMetas,
  ...
  var ListViewHeaderRow = /** @class */ (function (_super) {
    ...
    ListViewHeaderRow.prototype.render = function () {
      ...
      var hookProps = __assign({date: dateEnv.toDate(dayDate), view: viewApi, text: text, sideText: sideText, navLinkData: navLinkData}, dayMeta);
    ...
    if (options.displayEventTime !== false) {
      ...
      if (doAllDay) {
        ...
        return createElement(
          ...
          function (rootElRef, classNames, innerElRef, innerContent) {
            return createElement('td', {className: ['fc-list-event-time'].concat(classNames).join(' '), ref: rootElRef}, innerContent);
          },
        );
      }
  ...
  var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.render = function () {
      ...
      return createElement(ViewRoot, {viewSpec: context.viewSpec, elRef: this.setRootEl}, function (rootElRef, classNames) {
        return createElement(
          ...
          createElement(
            Scroller,
            {liquid: !props.isHeightAuto, overflowX: props.isHeightAuto ? 'visible' : 'hidden', overflowY: props.isHeightAuto ? 'visible' : 'auto'},
    ...
    ListView.prototype._eventStoreToSegs = function (eventStore, eventUiBases, dayRanges) {
      return this.eventRangesToSegs(
        sliceEventStore(eventStore, eventUiBases, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg,
        dayRanges,
      );
    };
